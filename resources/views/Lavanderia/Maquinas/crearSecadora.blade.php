...
@section('title', 'Nueva Secadora')
@section('content')

<!-- Título -->
<div class="container">
        <div class="col-12">
            <h3 class="text-center"><strong>Nueva Secadora</strong></h3>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12 d-flex justify-content-center">
            ...
            <form action="{{ route('secadora.save') }}" method="POST">
        @csrf
        ...
        <a href="/equiposLavanderia/secadoras" class="btn btn-danger mt-2">Cancelar</a>    
